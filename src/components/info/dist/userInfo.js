...
var UserInfo = function (_a) {
  ...
  react_1.useEffect(
    function () {
      var _a;
      setUserName(
        (_a = user === null || user === void 0 ? void 0 : user.data) === null ||
          _a === void 0
          ? void 0
          : _a.name,
      );
  ...
  return react_1['default'].createElement(
    'div',
    { className: info_less_1['default'].userInfo },
    changeUserName
      ? react_1['default'].createElement(
          'div',
          { style: { display: 'flex' } },
      ...
      : react_1['default'].createElement(
          ...
          renderItem(
            '用户名',
            (_b = user === null || user === void 0 ? void 0 : user.data) ===
              null || _b === void 0
              ? void 0
              : _b.name,
          ),
    ...
    renderItem(
      '目前进度',
      '\u7B2C' +
        (((_c = user === null || user === void 0 ? void 0 : user.data) ===
          null || _c === void 0
          ? void 0
          : _c.chapterId) || '-') +
        '\u7AE0-\u7B2C' +
        (((_d = user === null || user === void 0 ? void 0 : user.data) ===
          null || _d === void 0
          ? void 0
          : _d.checkpoint) || '-') +
        '\u8282',
